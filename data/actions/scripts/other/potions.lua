...
local potions = {
	...
	[7439] = {condition = berserk, {1, 2, 3, 4, 5, 6, 7, 8}, effect = CONST_ME_MAGIC_RED,
			description = "Only knights may drink this potion.", text = "You feel stronger."},

	[7440] = {condition = mastermind, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, effect = CONST_ME_MAGIC_BLUE,
			description = "Only sorcerers and druids may drink this potion.", text = "You feel smarter."},

	[7443] = {condition = bullseye, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, effect = CONST_ME_MAGIC_GREEN,
			description = "Only paladins may drink this potion.", text = "You feel more accurate."},

	[7588] = {health = {250, 350}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 50, flask = 7634,
			description = "Only knights and paladins of level 50 or above may drink this fluid."},

	[7589] = {mana = {115, 185}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 50, flask = 7634,
			description = "Only sorcerers, druids and paladins of level 50 or above may drink this fluid."},

	[7590] = {mana = {150, 250}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 80, flask = 7635,
			description = "Only druids and sorcerers of level 80 or above may drink this fluid."},

	[7591] = {health = {425, 575}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 80, flask = 7635,
	...
	[8472] = {health = {250, 350}, mana = {100, 200}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 80, flask = 7635,
			description = "Only paladins of level 80 or above may drink this fluid."},

	[8473] = {health = {650, 850}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 130, flask = 7635,
	...
	[26029] = {mana = {425, 575}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 130, flask = 7635,
			description = "Only druids and sorcerers of level 130 or above may drink this fluid."},

	[26030] = {health = {420, 580}, mana = {250, 350}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 130, flask = 7635,
			description = "Only paladins of level 130 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, vocations = {1, 2, 3, 4, 5, 6, 7, 8}, level = 200, flask = 7635,
